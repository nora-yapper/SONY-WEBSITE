    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 text-balance">Unified Champion Schools</h1>
        </div>
      </section>
      ...
      <section className="py-20 container mx-auto px-4">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 backdrop-blur-sm border border-primary/20 rounded-2xl p-8 md:p-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Three Components</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Program Benefits</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="bg-white border border-gray-200">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Social Inclusion</h3>
                  <p className="text-gray-700">
              ...
              <Card className="bg-white border border-gray-200">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Positive School Climate</h3>
                  <p className="text-gray-700">
